`ifndef __test_buton_pietoni
`define __test_buton_pietoni

`include "uvm_macros.svh"
//se includ fisierele la care testul trebuie sa aiba acces
`include "mediu_verificare.sv"
`include "secventa_apb_buton_pieton.sv"
`include "secventa_intrare_buton_pieton.sv"

class test_buton_pietoni extends uvm_test;
  `uvm_component_utils(test_buton_pietoni)
  
  
  //se declara constructorul testului
  function new(string name = "test_buton_pietoni", uvm_component parent=null);
  ...
  secventa_intrare_buton_pieton intrare_seq;
  secventa_apb_buton_pieton apb_seq;
...
//uvm_config_db#(virtual output_interface_dut)::set(this, "mediu_de_verificare.agent_apb_din_mediu.*", "apb_interface_dut",vif_apb_dut);
    ...
    apb_seq = secventa_apb_buton_pieton::type_id::create("apb_seq");
    apb_seq.randomize();

    intrare_seq = secventa_intrare_buton_pieton::type_id::create("intrare_seq");
  ...
  virtual task run_phase(uvm_phase phase);
    ...
    apply_reset();
    `uvm_info("test_buton_pietoni", "real execution begins", UVM_NONE);
