`ifndef __test_ora_actuala
`define __test_ora_actuala
...
`include "secventa_intrare_ora_actuala.sv"

class test_ora_actuala extends uvm_test;
  `uvm_component_utils(test_ora_actuala)
  
  
  //se declara constructorul testului
  function new(string name = "test_ora_actuala", uvm_component parent=null);
  ...
  secventa_intrare_ora_actuala intrare_seq;
...
//uvm_config_db#(virtual output_interface_dut)::set(this, "mediu_de_verificare.agent_apb_din_mediu.*", "apb_interface_dut",vif_apb_dut);
    ...
    intrare_seq = secventa_intrare_ora_actuala::type_id::create("intrare_seq");
  ...
  virtual task run_phase(uvm_phase phase);
    ...
    apply_reset();
    `uvm_info("test_ora_actuala", "real execution begins", UVM_NONE);
